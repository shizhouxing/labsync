...
def get_parser():
    ...
    parser.add_argument('--tb-port', type=int, default=9000,
                        help='Port of tensorboard server')
    parser.add_argument('--tb-logdir', type=str, default='tensorboard',
                        help='Directory of tensorboard log files')
    return parser
